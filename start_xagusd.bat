@echo off
REM === Alcadeias — XAGUSDm Single-Symbol Process ===
REM Usage: start_xagusd.bat [mode]
...
echo ============================================================
echo   STARTING XAGUSDm on %MODE% ACCOUNT
echo ============================================================
echo.
...
"%PYTHON_EXE%" -X utf8 -u app.py %MODE% --symbol XAGUSDm

echo.
echo ============= XAGUSDm PROCESS STOPPED =============
