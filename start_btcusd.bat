@echo off
REM === Alcadeias — EURUSDm Single-Symbol Process ===
REM Usage: start_EURUSD.bat [mode]
...
echo ============================================================
echo   STARTING EURUSDm on %MODE% ACCOUNT
echo ============================================================
echo.
...
"%PYTHON_EXE%" -X utf8 -u app.py %MODE% --symbol EURUSDm

echo.
echo ============= EURUSDm PROCESS STOPPED =============
