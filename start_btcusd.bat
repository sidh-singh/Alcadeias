@echo off
REM === Alcadeias — EURCHFm Single-Symbol Process ===
...
echo ============================================================
echo   STARTING EURCHFm on %MODE% ACCOUNT
echo ============================================================
echo.
...
"%PYTHON_EXE%" -X utf8 -u app.py %MODE% --symbol EURCHFm

echo.
echo ============= EURCHFm PROCESS STOPPED =============
