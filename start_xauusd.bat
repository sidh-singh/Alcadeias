@echo off
REM === Alcadeias — XAUUSDm Single-Symbol Process ===
REM Usage: start_xauusd.bat [mode]
...
echo ============================================================
echo   STARTING XAUUSDm on %MODE% ACCOUNT
echo ============================================================
echo.
...
"%PYTHON_EXE%" -X utf8 -u app.py %MODE% --symbol XAUUSDm

echo.
echo ============= XAUUSDm PROCESS STOPPED =============
