...
SHA_LENGTH = 35                      # Smoothing length for signal SHA (pre & post)
SHA_MA_TYPE = 'RMA'                 # MA type for signal SHA (SMA, EMA, RMA, WMA, HMA …)

# ─── SHA Trend Indicator ───
SHA_TREND_LENGTH = 70               # Smoothing length for trend SHA (pre & post)
...
CANDLE_COUNT = 350                   # Number of candles to fetch per cycle (needs ≥ 2×SHA_TREND_LENGTH warmup)
